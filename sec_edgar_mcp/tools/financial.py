...
class FinancialTools:
    ...
    def get_financials(
        ...
        try:
            ...
            result = {
                ...
                "statements": {},
                "filing_reference": {
                    "filing_date": latest_filing.filing_date.isoformat() if hasattr(latest_filing.filing_date, 'isoformat') else str(latest_filing.filing_date),
                    ...
                    if income is not None and hasattr(income, 'to_dict'):
                        ...
                        if xbrl and hasattr(xbrl, 'get_statement_by_type'):
                            try:
                                ...
                                if income_stmt:
                                    result["statements"]["income_statement"] = {"xbrl_statement": str(income_stmt)[:5000]}
                            except:
                                pass
    ...
    def _extract_balance_sheet(self, xbrl_data):
        ...
        balance_concepts = [
            ...
            "StockholdersEquity", "CommonStockValue", "RetainedEarningsAccumulatedDeficit"
        ]
    ...
    def _extract_cash_flow(self, xbrl_data):
        ...
        cash_concepts = [
            ...
            "PaymentsOfDividends", "ProceedsFromIssuanceOfDebt",
            "RepaymentsOfDebt"
        ]
    ...
    def get_segment_data(
        ...
        try:
            ...
            return {
                "success": False,
                "error": f"Failed to get segment data: {str(e)}"
            }
        ...
        try:
            ...
            if not metrics:
                metrics = [
                    ...
                    "CommonStockSharesOutstanding", "CashAndCashEquivalents"
                ]
            ...
            if not facts:
                return {
                    "success": False,
                    "error": "No facts data available for this company"
                }
            ...
            return {
                "success": False,
                "error": f"Failed to get key metrics: {str(e)}"
            }
    ...
    def discover_company_metrics(
        ...
        try:
            ...
            return {
                "success": False,
                "error": f"Failed to discover company metrics: {str(e)}"
            }
        ...
        try:
            ...
            if accession_number:
                ...
                if not filing:
                    return {
                        "success": False,
                        "error": f"Filing with accession number {accession_number} not found"
                    }
            else:
            ...
            return {
                "success": False,
                "error": f"Failed to get XBRL concepts: {str(e)}"
            }
        ...
        try:
            ...
            concept_patterns = {
                ...
                "income": [
                    ...
                    "CostOfRevenue", "EarningsPerShareBasic", "EarningsPerShareDiluted"
                ],
                "balance": [
    ...
    def discover_xbrl_concepts(
        ...
        try:
            ...
            statement_types = ["BalanceSheet", "IncomeStatement", "CashFlow", "StatementsOfIncome", 
                              "ConsolidatedBalanceSheets", "ConsolidatedStatementsOfOperations",
            ...
            return {
                "success": False,
                "error": f"Failed to discover XBRL concepts: {str(e)}"
            }